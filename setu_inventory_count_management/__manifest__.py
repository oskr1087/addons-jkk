{
    ...
    "depends": ["bus", "stock_account", "purchase"],
    "data": [
        ...
        "views/inventory_count_location_flow_views.xml",
        ...
        "views/inventory_count_scan_event_views.xml",
    ...
    "assets": {
        "web.assets_backend": [
            ...
            "setu_inventory_count_management/static/src/js/count_backend_dashboard.js",
            "setu_inventory_count_management/static/src/xml/count_backend_dashboard.xml",
        ],
    },
    "installable": True,
    "auto_install": False,
