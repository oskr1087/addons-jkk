...
class PlanningOperation(models.Model):
    ...
    duration = fields.Float(help='Processing duration in hours.', digits=(16, 4))
    setup_duration = fields.Float(help='Setup duration in hours.', digits=(16, 4))
    ...
    load_hours = fields.Float(compute='_compute_load_hours', store=True, digits=(16, 4))
...
class PlanningWorkcenterLoad(models.Model):
    ...
    available_hours = fields.Float(digits=(16, 4))
    load_hours = fields.Float(digits=(16, 4))
    utilization = fields.Float(compute='_compute_utilization', store=True, digits=(16, 4))
